...
async def meme_cmd(client: Client, message: Message):
    ...
    """
    msg = await edit_or_reply(message, "<b>🎨 Generating Meme...</b>")
    
    replied = message.reply_to_message
    if not replied or not replied.media:
        await msg.edit("<b>❌ Reply to an image!</b>")
        return
...
# chup be
    try:
        ...
        await client.send_photo(
            ...
            photo=out_path,
            caption=f"<b>😂 Meme Generated by Legendbot</b>"
        )
        await msg.delete()
        
    except Exception as e:
        await msg.edit(f"<b>❌ Meme Error:</b> {str(e)}")
    finally:
        # Cleanup
